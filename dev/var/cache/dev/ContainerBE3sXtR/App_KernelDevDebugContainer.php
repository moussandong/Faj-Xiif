...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\CommerceController' => 'getCommerceControllerService',
            ...
            'App\\Controller\\SpecialiteController' => 'getSpecialiteControllerService',
            'App\\Controller\\TypeEntrepriseController' => 'getTypeEntrepriseControllerService',
            ...
            'Vich\\UploaderBundle\\Naming\\SmartUniqueNamer.commerces' => 'getSmartUniqueNamer_CommercesService',
            'Vich\\UploaderBundle\\Naming\\SmartUniqueNamer.desserts' => 'getSmartUniqueNamer_DessertsService',
            'Vich\\UploaderBundle\\Naming\\SmartUniqueNamer.menus' => 'getSmartUniqueNamer_MenusService',
            'Vich\\UploaderBundle\\Naming\\SmartUniqueNamer.plats' => 'getSmartUniqueNamer_PlatsService',
            'Vich\\UploaderBundle\\Naming\\SmartUniqueNamer.produits' => 'getSmartUniqueNamer_ProduitsService',
            'Vich\\UploaderBundle\\Naming\\SmartUniqueNamer.supplements' => 'getSmartUniqueNamer_SupplementsService',
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('Rduah+ZlbQ', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('dQdNFpxwNw', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $c = new \Symfony\Bridge\Doctrine\ContainerAwareEventManager(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'vich_uploader.listener.clean.commerces' => ['privates', 'vich_uploader.listener.clean.commerces', 'getVichUploader_Listener_Clean_CommercesService', true],
            'vich_uploader.listener.clean.desserts' => ['privates', 'vich_uploader.listener.clean.desserts', 'getVichUploader_Listener_Clean_DessertsService', true],
            'vich_uploader.listener.clean.menus' => ['privates', 'vich_uploader.listener.clean.menus', 'getVichUploader_Listener_Clean_MenusService', true],
            'vich_uploader.listener.clean.plats' => ['privates', 'vich_uploader.listener.clean.plats', 'getVichUploader_Listener_Clean_PlatsService', true],
            'vich_uploader.listener.clean.produits' => ['privates', 'vich_uploader.listener.clean.produits', 'getVichUploader_Listener_Clean_ProduitsService', true],
            'vich_uploader.listener.clean.supplements' => ['privates', 'vich_uploader.listener.clean.supplements', 'getVichUploader_Listener_Clean_SupplementsService', true],
            'vich_uploader.listener.remove.commerces' => ['privates', 'vich_uploader.listener.remove.commerces', 'getVichUploader_Listener_Remove_CommercesService', true],
            'vich_uploader.listener.remove.desserts' => ['privates', 'vich_uploader.listener.remove.desserts', 'getVichUploader_Listener_Remove_DessertsService', true],
            'vich_uploader.listener.remove.menus' => ['privates', 'vich_uploader.listener.remove.menus', 'getVichUploader_Listener_Remove_MenusService', true],
            'vich_uploader.listener.remove.plats' => ['privates', 'vich_uploader.listener.remove.plats', 'getVichUploader_Listener_Remove_PlatsService', true],
            'vich_uploader.listener.remove.produits' => ['privates', 'vich_uploader.listener.remove.produits', 'getVichUploader_Listener_Remove_ProduitsService', true],
            'vich_uploader.listener.remove.supplements' => ['privates', 'vich_uploader.listener.remove.supplements', 'getVichUploader_Listener_Remove_SupplementsService', true],
            'vich_uploader.listener.upload.commerces' => ['privates', 'vich_uploader.listener.upload.commerces', 'getVichUploader_Listener_Upload_CommercesService', true],
            'vich_uploader.listener.upload.desserts' => ['privates', 'vich_uploader.listener.upload.desserts', 'getVichUploader_Listener_Upload_DessertsService', true],
            'vich_uploader.listener.upload.menus' => ['privates', 'vich_uploader.listener.upload.menus', 'getVichUploader_Listener_Upload_MenusService', true],
            'vich_uploader.listener.upload.plats' => ['privates', 'vich_uploader.listener.upload.plats', 'getVichUploader_Listener_Upload_PlatsService', true],
            'vich_uploader.listener.upload.produits' => ['privates', 'vich_uploader.listener.upload.produits', 'getVichUploader_Listener_Upload_ProduitsService', true],
            'vich_uploader.listener.upload.supplements' => ['privates', 'vich_uploader.listener.upload.supplements', 'getVichUploader_Listener_Upload_SupplementsService', true],
        ], [
            'doctrine.orm.default_listeners.attach_entity_listeners' => '?',
            'doctrine.orm.listeners.pdo_cache_adapter_doctrine_schema_subscriber' => '?',
            'vich_uploader.listener.clean.commerces' => '?',
            'vich_uploader.listener.clean.desserts' => '?',
            'vich_uploader.listener.clean.menus' => '?',
            'vich_uploader.listener.clean.plats' => '?',
            'vich_uploader.listener.clean.produits' => '?',
            'vich_uploader.listener.clean.supplements' => '?',
            'vich_uploader.listener.remove.commerces' => '?',
            'vich_uploader.listener.remove.desserts' => '?',
            'vich_uploader.listener.remove.menus' => '?',
            'vich_uploader.listener.remove.plats' => '?',
            'vich_uploader.listener.remove.produits' => '?',
            'vich_uploader.listener.remove.supplements' => '?',
            'vich_uploader.listener.upload.commerces' => '?',
            'vich_uploader.listener.upload.desserts' => '?',
            'vich_uploader.listener.upload.menus' => '?',
            'vich_uploader.listener.upload.plats' => '?',
            'vich_uploader.listener.upload.produits' => '?',
            'vich_uploader.listener.upload.supplements' => '?',
        ]), [0 => 'vich_uploader.listener.clean.plats', 1 => 'vich_uploader.listener.clean.desserts', 2 => 'vich_uploader.listener.clean.commerces', 3 => 'vich_uploader.listener.clean.menus', 4 => 'vich_uploader.listener.clean.produits', 5 => 'vich_uploader.listener.clean.supplements', 6 => 'doctrine.orm.listeners.pdo_cache_adapter_doctrine_schema_subscriber', 7 => 'vich_uploader.listener.remove.plats', 8 => 'vich_uploader.listener.upload.plats', 9 => 'vich_uploader.listener.remove.desserts', 10 => 'vich_uploader.listener.upload.desserts', 11 => 'vich_uploader.listener.remove.commerces', 12 => 'vich_uploader.listener.upload.commerces', 13 => 'vich_uploader.listener.remove.menus', 14 => 'vich_uploader.listener.upload.menus', 15 => 'vich_uploader.listener.remove.produits', 16 => 'vich_uploader.listener.upload.produits', 17 => 'vich_uploader.listener.remove.supplements', 18 => 'vich_uploader.listener.upload.supplements']);
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'App\\Repository\\CommerceRepository' => ['privates', 'App\\Repository\\CommerceRepository', 'getCommerceRepositoryService', true],
            ...
            'App\\Repository\\TypeEntrepriseRepository' => ['privates', 'App\\Repository\\TypeEntrepriseRepository', 'getTypeEntrepriseRepositoryService', true],
            'App\\Repository\\TypeProduitRepository' => ['privates', 'App\\Repository\\TypeProduitRepository', 'getTypeProduitRepositoryService', true],
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('x7UCtYeJAM', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('DIgGgLwcvg', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('vXKv4scGZR', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('q6d-FZGPMV', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.bundles_metadata' => [
                ...
                'EasyDeployBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/easycorp/easy-deploy-bundle/src'),
            ...
            'vich_uploader.mappings' => [
                'plats' => [
                    ...
                    'upload_destination' => (\dirname(__DIR__, 4).'/public/images/plats'),
                    'namer' => [
                        'service' => 'Vich\\UploaderBundle\\Naming\\SmartUniqueNamer.plats',
                        'options' => [
                ...
                'desserts' => [
                    'uri_prefix' => '/images/desserts',
                    'upload_destination' => (\dirname(__DIR__, 4).'/public/images/desserts'),
                    'namer' => [
                        'service' => 'Vich\\UploaderBundle\\Naming\\SmartUniqueNamer.desserts',
                        'options' => [
                ...
                'commerces' => [
                    'uri_prefix' => '/images/commerces',
                    'upload_destination' => (\dirname(__DIR__, 4).'/public/images/commerces'),
                    'namer' => [
                        'service' => 'Vich\\UploaderBundle\\Naming\\SmartUniqueNamer.commerces',
                        'options' => [
                ...
                'menus' => [
                    'uri_prefix' => '/images/menus',
                    'upload_destination' => (\dirname(__DIR__, 4).'/public/images/menus'),
                    'namer' => [
                        'service' => 'Vich\\UploaderBundle\\Naming\\SmartUniqueNamer.menus',
                        'options' => [
                ...
                'produits' => [
                    ...
                    'upload_destination' => (\dirname(__DIR__, 4).'/public/images/produits'),
                    'namer' => [
                        'service' => 'Vich\\UploaderBundle\\Naming\\SmartUniqueNamer.produits',
                        'options' => [
                ...
                'supplements' => [
                    'uri_prefix' => '/images/supplements',
                    'upload_destination' => (\dirname(__DIR__, 4).'/public/images/supplements'),
                    'namer' => [
                        'service' => 'Vich\\UploaderBundle\\Naming\\SmartUniqueNamer.supplements',
                        'options' => [
