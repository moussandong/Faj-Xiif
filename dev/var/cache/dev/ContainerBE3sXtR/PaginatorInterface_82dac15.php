...
class PaginatorInterface_82dac15 implements \ProxyManager\Proxy\VirtualProxyInterface, \Knp\Component\Pager\PaginatorInterface
{
    ...
    {
        $this->initializer6ad88 && ($this->initializer6ad88->__invoke($valueHolderd3cb1, $this, 'paginate', array('target' => $target, 'page' => $page, 'limit' => $limit, 'options' => $options), $this->initializer6ad88) || 1) && $this->valueHolderd3cb1 = $valueHolderd3cb1;

        if ($this->valueHolderd3cb1 === $returnValue = $this->valueHolderd3cb1->paginate($target, $page, $limit, $options)) {
            return $this;
        }
