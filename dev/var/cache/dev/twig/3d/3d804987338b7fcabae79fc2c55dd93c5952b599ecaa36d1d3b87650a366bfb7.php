...
class __TwigTemplate_1d0d58a71c9c7f6f713ad8bf1df315dbb93a6cbcd3865fc811978b1497e45157 extends Template
{
    private $source;
    private $macros = [];
...
\t";
        // line 14
        if ((1 === twig_compare(twig_length_filter($this->env, (isset($context["items"]) || array_key_exists("items", $context) ? $context["items"] : (function () { throw new RuntimeError('Variable "items" does not exist.', 14, $this->source); })())), 0))) {
            // line 15
