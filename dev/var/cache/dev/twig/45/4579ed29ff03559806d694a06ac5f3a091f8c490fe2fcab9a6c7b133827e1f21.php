...
class __TwigTemplate_ffc82750ca9e4a1160dd34ac367a8e6f84f9d6600c0e2985f46f81ec0bd3e97b extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 6
        echo "    <h1>Enrégistrer un nouveau Produit</h1>
...
{% block body %}
    <h1>Enrégistrer un nouveau Produit</h1>

    {{ include('produit/_form.html.twig') }}

    <a href=\"{{ path('produit_index') }}\">retour à la liste</a>
{% endblock %}
", "produit/new.html.twig", "/Users/ndongmoussa/Desktop/localhost/symfony/faj_xiif/dev/templates/produit/new.html.twig");
    }
}
