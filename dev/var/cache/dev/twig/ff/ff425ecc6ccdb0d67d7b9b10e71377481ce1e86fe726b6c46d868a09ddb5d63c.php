...
class __TwigTemplate_e4d59a6b17596eebf8393c51dc722119822c9c4398b7a24e484051abdfb1a06c extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["commande"]) {
            ...
            echo "</td>
                <td>";
            // line 20
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["commande"], "prix", [], "any", false, false, false, 20), "html", null, true);
            echo "</td>
                <td>
                    <a href=\"";
            // line 22
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("commande_show", ["id" => twig_get_attribute($this->env, $this->source, $context["commande"], "id", [], "any", false, false, false, 22)]), "html", null, true);
            echo "\">voir</a>
                    <a href=\"";
            // line 23
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("commande_edit", ["id" => twig_get_attribute($this->env, $this->source, $context["commande"], "id", [], "any", false, false, false, 23)]), "html", null, true);
            echo "\">modifier</a>
                </td>
            </tr>
        ";
        ...
        if (!$context['_iterated']) {
            // line 27
            echo "            <tr>
                <td colspan=\"3\">pas de comande</td>
            </tr>
        ";
        }
...
{% block body %}
    ...
    <table class=\"table\">
        ...
        {% for commande in commandes %}
            <tr>
                ...
                <td>{{ commande.prix }}</td>
                <td>
                    <a href=\"{{ path('commande_show', {'id': commande.id}) }}\">voir</a>
                    <a href=\"{{ path('commande_edit', {'id': commande.id}) }}\">modifier</a>
                </td>
            </tr>
        {% else %}
            <tr>
    ...
    <a href=\"{{ path('home') }}\">Passer commande</a>
{% endblock %}
", "commande/index.html.twig", "/Users/ndongmoussa/Desktop/localhost/symfony/faj_xiif/dev/templates/commande/index.html.twig");
    }
}
