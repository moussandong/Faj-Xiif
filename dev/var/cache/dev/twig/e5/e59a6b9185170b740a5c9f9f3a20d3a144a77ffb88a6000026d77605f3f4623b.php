...
class __TwigTemplate_2f1a79c4755169d026bad95f6f7c53b0e5a6d167af4bdc54e7dd8d556bf71316 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("commande_delete", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["commande"]) || array_key_exists("commande", $context) ? $context["commande"] : (function () { throw new RuntimeError('Variable "commande" does not exist.', 1, $this->source); })()), "id", [], "any", false, false, false, 1)]), "html", null, true);
        echo "\" onsubmit=\"etes-vous sure ?');\">
...
";
    ...
    {
        return new Source("<form method=\"post\" action=\"{{ path('commande_delete', {'id': commande.id}) }}\" onsubmit=\"etes-vous sure ?');\">
    <input type=\"hidden\" name=\"_method\" value=\"DELETE\">
    <input type=\"hidden\" name=\"_token\" value=\"{{ csrf_token('delete' ~ commande.id) }}\">
    <button class=\"btn\">Supprimer</button>
</form>
", "commande/_delete_form.html.twig", "/Users/ndongmoussa/Desktop/localhost/symfony/faj_xiif/dev/templates/commande/_delete_form.html.twig");
    }
}
