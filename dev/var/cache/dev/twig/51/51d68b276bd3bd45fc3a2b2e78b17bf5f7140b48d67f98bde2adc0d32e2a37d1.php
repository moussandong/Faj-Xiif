...
class __TwigTemplate_92f8fed0bd2b6f53bad578ec407353e4a8fc8d1cef58f139bf73bc526ee8e079 extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        echo "</td>
            ...
            <tr>
                ...
                <td>";
        // line 16
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["produit"]) || array_key_exists("produit", $context) ? $context["produit"] : (function () { throw new RuntimeError('Variable "produit" does not exist.', 16, $this->source); })()), "imageName", [], "any", false, false, false, 16), "html", null, true);
        echo "</td>
            </tr>
            <tr>
                <th>Nom</th>
...
{% block body %}
    ...
    <a href=\"{{ path('produit_index') }}\">retour à la liste</a>

    <a href=\"{{ path('produit_edit', {'id': produit.id}) }}\">modifier</a>

    {{ include('produit/_delete_form.html.twig') }}
{% endblock %}
", "produit/show.html.twig", "/Users/ndongmoussa/Desktop/localhost/symfony/faj_xiif/dev/templates/produit/show.html.twig");
    }
}
